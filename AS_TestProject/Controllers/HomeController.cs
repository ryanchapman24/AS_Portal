...
namespace AS_TestProject.Controllers
{
    ...
    public class HomeController : UserNames
    {
        public ActionResult Index()
        {
            ...
            ViewBag.DailyFiles = db.EmployeeFiles.Where(f => f.Created.Year == todayYear && f.Created.Month == todayMonth && f.Created.Day == todayDay).Count() + db.Documents.Where(f => f.Created.Year == todayYear && f.Created.Month == todayMonth && f.Created.Day == todayDay).Count();
